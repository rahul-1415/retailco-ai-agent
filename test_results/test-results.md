...
- **Classification accuracy**: All 12 items in RetailCo_Invoice.pdf and all 7 in R-1093-24524.pdf classified correctly to expected categories (Bottled Water 0%, Soft Drinks 6.5%, Tobacco Products 12%, OTC Medicine 4%, Car Batteries 8%, Tires 8%, Tools & Hardware 7%, Paint & Finishes 7%, Bedding & Linens 7.5%, Bottled Water 0%).
...
```json
{
  ...
  "line_item_taxes": [
    {
      "description": "Smartwater Vapor Distilled – 6 Pack (1L)",
      "quantity": 30.0,
      "unit_price": 9.99,
      "total_amount": 299.7,
    ...
    {
      "description": "Poland Spring Natural Spring Water – 24 Pack",
      "quantity": 20.0,
      "unit_price": 6.49,
      "total_amount": 129.8,
      "category": "Bottled Water",
    ...
    {
      "description": "Coca-Cola Original – 12 Pack (12 fl oz Cans)",
      "quantity": 12.0,
      "unit_price": 8.99,
      "total_amount": 107.88,
    ...
    {
      "description": "Sprite Lemon-Lime – 8 Pack (12 fl oz Bottles)",
      "quantity": 13.0,
      "unit_price": 7.99,
      "total_amount": 103.87,
      "category": "Soft Drinks",
    ...
    {
      "description": "Black & Mild Cigars – Wine Tip, 5 Pack",
      "quantity": 40.0,
      "unit_price": 7.49,
      "total_amount": 299.6,
    ...
    {
      "description": "Advil Ibuprofen Tablets – 200 mg, 100 Count",
      "quantity": 111.0,
      "unit_price": 11.99,
      "total_amount": 1330.89,
      "category": "Over-the-Counter Medicine",
      "tax_rate": 4.0,
      "tax_amount": 53.24
    },
    {
      "description": "Tylenol Extra Strength Caplets – 500 mg, 100 Count",
      "quantity": 45.0,
      "unit_price": 12.99,
      "total_amount": 584.55,
      "category": "Over-the-Counter Medicine",
    ...
    {
      "description": "Claritin 24-Hour Allergy Relief Tablets – 30 Count",
      "quantity": 32.0,
      "unit_price": 21.99,
      "total_amount": 703.68,
      "category": "Over-the-Counter Medicine",
    ...
    {
      "description": "Duracell Automotive Battery – Group H7, 800 CCA",
      "quantity": 14.0,
      "unit_price": 179.99,
      "total_amount": 2519.86,
      "category": "Car Batteries",
      "tax_rate": 8.0,
      "tax_amount": 201.59
    },
    {
      "description": "NAPA Legend Premium Battery – Group 75, 690 CCA",
      "quantity": 14.0,
      "unit_price": 162.99,
      "total_amount": 2281.86,
      "category": "Car Batteries",
      "tax_rate": 8.0,
      "tax_amount": 182.55
    },
    {
      "description": "Michelin Defender LTX M/S Tire – 265/70R17",
      "quantity": 10.0,
      "unit_price": 198.5,
      "total_amount": 1985.0,
      "category": "Tires",
    ...
    {
      "description": "Goodyear Assurance All-Season Tire – 225/60R16",
      "quantity": 12.0,
      "unit_price": 142.99,
      "total_amount": 1715.88,
      "category": "Tires",
      "tax_rate": 8.0,
      "tax_amount": 137.27
    }
...
```json
{
  ...
  "line_item_taxes": [
    {
      "description": "BrightWave Laundry Pods – 42 Count – ID: 68840",
      "quantity": 50.0,
      "unit_price": 799.5,
      "total_amount": 799.5,
      "category": "Tax Exempt",
    ...
    {
      "description": "EcoSoft Plant-Based Detergent – 90 oz – ID: 40192",
      "quantity": 40.0,
      "unit_price": 499.6,
      "total_amount": 499.6,
      "category": "Tax Exempt",
    ...
    {
      "description": "Dawn Ultra Dishwashing Liquid – 38 oz Bottle – ID: 81976",
      "quantity": 25.0,
      "unit_price": 107.25,
      "total_amount": 107.25,
      "category": "Tax Exempt",
    ...
    {
      "description": "Energizer MAX AA Batteries – 24 Pack – ID: 58723",
      "quantity": 100.0,
      "unit_price": 1899.0,
      "total_amount": 1899.0,
      "category": "Tax Exempt",
    ...
    {
      "description": "Hamilton Beach 2-Slice Toaster – Brushed Steel – ID: 27685",
      "quantity": 25.0,
      "unit_price": 874.75,
      "total_amount": 874.75,
      "category": "Tax Exempt",
    ...
    {
      "description": "Gibson Stoneware Dinner Set – 20 Piece – ID: 26590",
      "quantity": 20.0,
      "unit_price": 1199.8,
      "total_amount": 1199.8,
      "category": "Tax Exempt",
    ...
    {
      "description": "Threshold Ceramic Mug Set – 6 Count – ID: 38452",
      "quantity": 30.0,
      "unit_price": 749.7,
      "total_amount": 749.7,
      "category": "Tax Exempt",
...
```
  ...
  [6/7] AquaPure – Natural Spring Water – 6 Pack (1L) – ID → Bottled Water (0.0%)
  [7/7] Brooklinen Luxe Core Sheet Set – Queen – ID: 67088 → Bedding & Linens (7.5%)
```

Note: `unit_price` is `null` for all items — Delta-Distribution two-column format, unit price not available as a separate field. `quantity` was parsed from the description string.
...
```json
{
  ...
  "line_item_taxes": [
    {
      "description": "Kobalt Adjustable Wrench Set – 3 Piece – ID: 18429",
      "quantity": 40.0,
      "unit_price": null,
      "total_amount": 1399.6,
    ...
    {
      "description": "Milwaukee Hammer Drill – 1/2\" 18V – ID: 71360",
      "quantity": 20.0,
      "unit_price": null,
      "total_amount": 3580.0,
      "category": "Tools & Hardware",
    ...
    {
      "description": "Behr Premium Interior Paint – 1 Gallon – ID: 92173",
      "quantity": 50.0,
      "unit_price": null,
      "total_amount": 2099.5,
    ...
    {
      "description": "Valspar Ultra Exterior Paint – 1 Gallon – ID: 39520",
      "quantity": 35.0,
      "unit_price": null,
      "total_amount": 1539.65,
      "category": "Paint & Finishes",
      "tax_rate": 7.0,
      "tax_amount": 107.78
    },
    {
      "description": "ClearSpring – Purified Water – 24 Pack (16.9 fl oz) – ID: 60674",
      "quantity": 16.0,
      "unit_price": null,
      "total_amount": 103.84,
      "category": "Bottled Water",
    ...
    {
      "description": "AquaPure – Natural Spring Water – 6 Pack (1L) – ID: 91530",
      "quantity": 10.0,
      "unit_price": null,
      "total_amount": 89.9,
      "category": "Bottled Water",
    ...
    {
      "description": "Brooklinen Luxe Core Sheet Set – Queen – ID: 67088",
      "quantity": 30.0,
      "unit_price": null,
      "total_amount": 4770.0,
...
Classification skipped — all items tagged `Tax Exempt`, `tax_rate: 0`. `unit_price` is `null` throughout (Delta-Distribution two-column format).
...
```json
{
  ...
  "line_item_taxes": [
    {
      "description": "Used- \"To Kill A Mockingbird\" – Harper Lee – Hardcover – ID: 55086",
      "quantity": 15.0,
      "unit_price": null,
      "total_amount": 337.35,
      "category": "Tax Exempt",
    ...
    {
      "description": "Used- \"The Great Gatsby\" – F. Scott Fitzgerald – ID: 90573",
      "quantity": 16.0,
      "unit_price": null,
      "total_amount": 239.84,
      "category": "Tax Exempt",
    ...
    {
      "description": "Used- \"Educated\" – Tara Westover – Paperback – ID: 18704",
      "quantity": 10.0,
      "unit_price": null,
      "total_amount": 189.9,
      "category": "Tax Exempt",
    ...
    {
      "description": "Used- Hasbro Monopoly Deluxe Edition – ID: 42297",
      "quantity": 20.0,
      "unit_price": null,
      "total_amount": 599.8,
      "category": "Tax Exempt",
    ...
    {
      "description": "Used- Mattel UNO Card Game – ID: 51783",
      "quantity": 17.0,
      "unit_price": null,
      "total_amount": 169.83,
      "category": "Tax Exempt",
    ...
    {
      "description": "Used- Ravensburger 1000-Piece Jigsaw Puzzle – ID: 68817",
      "quantity": 24.0,
      "unit_price": null,
      "total_amount": 479.76,
      "category": "Tax Exempt",
    ...
    {
      "description": "Used- Nerf Elite Blaster – 25 Darts – ID: 31948",
      "quantity": 15.0,
      "unit_price": null,
      "total_amount": 599.85,
      "category": "Tax Exempt",
    ...
    {
      "description": "Used- Breville Smart Toaster Oven – Compact – ID: 83172",
      "quantity": 6.0,
      "unit_price": null,
      "total_amount": 894.0,
      "category": "Tax Exempt",
    ...
    {
      "description": "Used- Hamilton Beach 2-Slice Toaster – Brushed Steel – ID: 27685",
      "quantity": 8.0,
      "unit_price": null,
      "total_amount": 279.92,
      "category": "Tax Exempt",
    ...
    {
      "description": "Used- Cuisinart 12-Cup Coffee Maker – Programmable – ID: 54328",
      "quantity": 3.0,
      "unit_price": null,
      "total_amount": 269.97,
      "category": "Tax Exempt",
